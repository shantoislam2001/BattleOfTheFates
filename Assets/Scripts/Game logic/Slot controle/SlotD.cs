...
public class SlotD : MonoBehaviour
{
    public AIManager ai;
    ...
    public void startGame()
    {
        ...
        timer.StartTimer("Chasing timerD", 15f, () =>
        {
            timerUIisOn = false;
            winer();
        });
    ...
    void Update()
    {
        if (timerUIisOn)
        {
            timerText.text = timer.GetSecondsString("Chasing timerD");
        }
    }
